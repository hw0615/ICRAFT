$(function() {
  ...
  function getDisclosure() {
    ...
    $.ajax({    
      type: "GET",
      url: 'https://nllyo9o76k.execute-api.ap-northeast-2.amazonaws.com/prod/disclosure?page=' + pageNum,
      dataType: "JSON",
      error: function(){
        console.log('실패');
      },
      success: function(data){ 
        ...
        for(var i=1; i <= pageLength; i++){
          ...
          $(pageAT).attr("href", pageUrl[0] + "?page=" + i );
          $(pageAT).append(i);   
          if(i == pageNum){
          ...
          switch(direction) {
            case "left":          
              if( 1 < pageNum && pageNum <= pageLength){              
                ...
                $(pageLeftArrow).attr("href", pageUrl[0] + "?page=" + pageNum)
            ...
            case "right":          
              if( pageNum < pageLength ){
                ...
                $(pageRightArrow).attr("href", pageUrl[0] + "?page=" + pageNum)
